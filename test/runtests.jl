...
@testset "AWSCRT.jl" begin
    @testset "connect, connect!" begin end
    @testset "subscribe, subscribe!" begin end
    @testset "publish, publish!" begin end
    @testset "unsubscribe, unsubscribe!" begin end
    @testset "disconnect, disconnect!" begin end
end
